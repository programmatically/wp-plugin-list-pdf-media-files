...
Use [listpdfs] short code to link all PDF in your media library into a page or post. The PDF's will appear as a list of links using target="_blank" so that the PDF's open in a new window.
